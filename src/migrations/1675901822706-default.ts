...
export class default1675901822706 implements MigrationInterface {
    name = 'default1675901822706'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product_wishlist\` ADD CONSTRAINT \`FK_89dc0a67d7b388f1d79aa3d7635\` FOREIGN KEY (\`wishlist_id\`) REFERENCES \`products\`(\`product_id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`product_wishlist\` ADD CONSTRAINT \`FK_49b9f34ac2e43a9972123090c36\` FOREIGN KEY (\`product_id\`) REFERENCES \`wishlists\`(\`wishlist_id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
